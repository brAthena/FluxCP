...
<p>Bem-vindo à lista de tarefas, <?php echo $staffsess->preferred_name ?>. Lista de Tarefas é um addon para FluxCP que permite o gerenciamento de tarefas, adicionando coisas para fazer a lista, em seguida, atribuí-las a um membro com uma prioridade.</p>
<?php if($tasklist): ?>
...
<?php else: ?>
	<p>
		...
		<a href="<?php echo $this->url('tasks', 'createnew') ?>">Criar uma tarefa</a>
	</p>
<?php endif ?>