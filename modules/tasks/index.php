...
$staff = $sth->fetchAll();
if(!$staff){
	$session->setMessageData('!!!Erro!!! Conta não existe na tabela de configurações de equipe! Por favor, envie seu nome antes de utilizar a lista de tarefas.'); $this->redirect($this->url('tasks','staffsettings'));
} else {
